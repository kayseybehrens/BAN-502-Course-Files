...
Split the data (training and testing). 70% of the data to training. Stratified the random split by the response variable "HeartDisease". Random number seed set is 12345.
```{r}
set.seed(12345)
...
Looking at the tree a few different ways
```{r}
